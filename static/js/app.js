...
class VoronConfigurator {
    ...
    async openReferenceConfigInTab() {
        ...
        // Open reference config in new browser tab with simplified view
        const url = `/reference/${printer}/${board}/${revision}`;
        
        // Open in new tab
        window.open(url, '_blank');
        
        this.showMessage(`Opening ${configName} in new browser tab...`, 'success');
    }
